...
if(APPLE)
    ...
    list(FILTER client_exec INCLUDE REGEX [[AbstractumVPN$]])
    set(service_exec ${execs})
    list(FILTER service_exec INCLUDE REGEX [[AbstractumVPN-service$]])
    set(other_execs ${execs})
    list(FILTER other_execs EXCLUDE REGEX [[AbstractumVPN$|AbstractumVPN-service$]])
